...
check_file "Security config" "configuration/security.nix"
check_file "Security production" "configuration/security-production.nix"
check_file "Monitoring" "configuration/monitoring.nix"

echo ""
echo "━━━ Enterprise Features ━━━"
check_file "Centralized logging" "configuration/centralized-logging.nix"
check_file "Resource quotas" "configuration/resource-quotas.nix"
check_file "Network isolation" "configuration/network-isolation.nix"
check_file "Storage quotas" "configuration/storage-quotas.nix"
check_file "Snapshot lifecycle" "configuration/snapshot-lifecycle.nix"
check_file "VM encryption" "configuration/vm-encryption.nix"
