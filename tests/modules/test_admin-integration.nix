...

{
  ...
  nodes.machine = { config, pkgs, ... }: {
    ...
    hypervisor.admin-integration.enable = lib.mkDefault true;
  };
  ...
  testScript = ''
    ...
    with subtest("Module loaded"):
        ...
        machine.succeed("echo 'Module admin-integration loaded'")
    ...
    print("✓ admin-integration tests passed")
  '';
}
