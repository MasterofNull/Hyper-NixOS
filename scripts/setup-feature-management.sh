...
echo -e "  • ${BLUE}feature-manager${NC} - Launch the interactive feature management wizard"
echo -e "  • ${BLUE}hv-features${NC} - Quick access to feature manager"
echo -e "  • ${BLUE}hv-feature${NC} - Command-line feature information tool"
echo -e "  • ${BLUE}hv-template${NC} - Template management commands"
echo -e "  • ${BLUE}hv-apply-template${NC} - Quick template application"
...
echo -e "\nNext steps:"
echo -e "1. Run '${BLUE}feature-manager${NC}' to customize your system"
echo -e "2. Or use '${BLUE}hv-apply-template <tier>${NC}' for quick setup"
echo -e "3. View the feature catalog at ${BLUE}/docs/FEATURE_CATALOG.md${NC}"
echo -e "4. Read the guide at ${BLUE}/docs/FEATURE_MANAGEMENT_GUIDE.md${NC}"
