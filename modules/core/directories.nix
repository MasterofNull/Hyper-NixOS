...

{
  systemd.tmpfiles.rules = lib.mkMerge [
    ...
    (lib.mkIf (config.hypervisor.security.profile == "headless") [
      ...
      "d /var/lib/hypervisor/vm-profiles 0775 root libvirtd - -"
    ...
    (lib.mkIf (config.hypervisor.security.profile == "management") [
      ...
      "d /var/lib/hypervisor/vm-profiles 0750 ${config.hypervisor.management.userName} ${config.hypervisor.management.userName} - -"
